...
public class ThreeDayNextActivity extends AppCompatActivity {
    ...
    private void get7DayData(final String data) {
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(ThreeDayNextActivity.this);
...
//                            String name = jsonObjectCity.getString("name");
    ...
    private void initView() {
        ...
        weatherAdapter = new WeatherAdapter(ThreeDayNextActivity.this,weatherList);
