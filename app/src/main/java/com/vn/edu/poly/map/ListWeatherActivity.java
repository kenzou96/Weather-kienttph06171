...
public class ListWeatherActivity extends AppCompatActivity {
    ...
    private void get7DayData(final String data) {
        String url = "https://api.openweathermap.org/data/2.5/forecast/?q=" + data + "&units=metric&cnt=8&appid=bcfd474bf493e3a37251b7d238e947b3";
        RequestQueue requestQueue = Volley.newRequestQueue(ListWeatherActivity.this);
...
//                            String name = jsonObjectCity.getString("name");
    ...
    private void initView() {
        ...
        weatherAdapter = new WeatherAdapter(ListWeatherActivity.this,weatherList);
