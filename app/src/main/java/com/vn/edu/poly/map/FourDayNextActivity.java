...
public class FourDayNextActivity extends AppCompatActivity {
    ...
    private void get7DayData(final String data) {
        String url = "https://api.openweathermap.org/data/2.5/forecast/?q=" + data + "&units=metric&cnt=32&appid=bcfd474bf493e3a37251b7d238e947b3";
        RequestQueue requestQueue = Volley.newRequestQueue(FourDayNextActivity.this);
...
//                            String name = jsonObjectCity.getString("name");
                            ...
                            for(int i=24 ; i<jsonArrayList.length();i++){
    ...
    private void initView() {
        ...
        weatherAdapter = new WeatherAdapter(FourDayNextActivity.this,weatherList);
